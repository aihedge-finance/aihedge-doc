...
> [!TIP]
> **Which rate should you use as a benchmark?**
...
2. **Strategy Accrual:** As capital is deployed across Morpho, Moonwell, and Market Making pools, interest and trading fees accumulate.
...
- **Lending Utilization (Morpho / Moonwell):** When borrowing demand rises across money markets, lending rates surge; during low-activity periods, rates moderate.
...
graph TD
    ...
    C --> E["Actual Compounded On-Chain Harvest Reports"]
```
...
1. **Projected APY (Top / Primary):**
   ...
   - **Lending Strategies (e.g., Moonwell Flagship, Morpho):** Displays the live variable supply rate per second derived from borrower utilization.
   - **Market Making Strategies (e.g., USDC Market Making):** Displays projected fee yields based on recent trading volume velocity and active reward rates.
