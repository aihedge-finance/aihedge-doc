...
* **Strategy Adaptors**: Specialized contract interfaces that deposit and withdraw assets directly to/from DeFi providers like Morpho, Aave, Curve, and Compound.
